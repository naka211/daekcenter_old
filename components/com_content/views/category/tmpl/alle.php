				...
				<div id="DCLocations">
                              ...
                              <div id="DCMap">
									...
									<?php for($i=0;$i<count($row);$i++) {?>
                                        <a id="loc<?php echo $i?>" href="<?php if($row[$i]->fax){?>index.php?option=com_content&view=category&layout=iframe-link&firma=<?php echo $row[$i]->dfi_shop_id?>&id=11&Itemid=27l<?php }else echo "#" ?>" data-tooltip="tip<?php echo $i?>" style="top: <?php echo $row[$i]->y_value?>px; left: <?php echo $row[$i]->x_value ?>px;"></a> 
