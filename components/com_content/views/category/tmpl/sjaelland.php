...
<div class="w950" id="contentFrame">
								...
								<?php
								$db1 = &JFactory::getDBO();
								$query1 = "SELECT *, shops.filename, shops.fax, shops.description FROM #__dfi_maps AS maps, #__dfi_shops AS shops, #__dfi_catalogs AS catalog WHERE maps.dfi_shop_id=shops.dfi_shop_id AND catalog.catid=9 AND shops.dfi_shops_catid=catalog.dfi_catalog_id  GROUP BY shops.company_name";
								$db1->setQuery($query1);
