...
<div id="contentFrame">
				...
				<div class="f-search">
					<form name="fromSearch" action="index.php" method="get">
						...
						<a onclick="searchtext();" href="javascript:void(0);" class="bntGo" href="#">Go</a>
				...
				<div class="clear"></div>
                              ...
                              <div id="DCMap1">
									...
									<div class="follow-us">
                                        <a class="bntFollow" href="http://facebook.com/daekcenter" target="_blank">Følg os på</a>
                                    </div><!--.follow-us-->
                                </div>
                                <!-- /The Map -->
						...
						<div class="departments-list" id="jylland">
									...
									<div class="department-item">
                                        ...
                                        <div class="desc grid-5">
                                            ...
                                            <a href="<?php if($iarray[$i]->butiksnr){?>index.php?option=com_content&view=category&layout=iframeapp&firma=<?php echo $iarray[$i]->dfi_shop_id?>&id=11&Itemid=27 <?php }else echo "#" ?>" class="firma-kort-btn">Se fir
fo og kort</a>
                                        </div>
										<div class="fl w280">
										<!--	
