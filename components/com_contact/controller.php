...
class ContactController extends JController
{
	...
	function submit()
	{
        ...
        $contact= "DIN ISENKRÆMMER Kontakt";
        
        $subject	= "DIN ISENKRÆMMER KONTAKT";
		$body		= "DIN ISENKRÆMMER Kontakt";
		...
		/*
		global $mainframe;
		$msg = JText::_( 'Contact message' );
		$mainframe->setUserState( 'com_kontaktmsg', $msg );
		*/
		$msg = JText::_( 'Thank you for your e-mail');
		$link = JRoute::_('index.php?option=com_contact&view=contact&layout=success&id='.$contact->slug.'&catid='.$contact->catslug, false);
