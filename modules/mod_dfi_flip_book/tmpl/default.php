...
<div style="position:absolute; right:37px;top:52px; z-index:1000">
            	<a href="index.php" style="background:none"><img src="<? echo $template_dir; ?>img/tilbage.png" alt=""/></a>
            </div>
	...
	if (AC_FL_RunContent == 0) {
		...
		AC_FL_RunContent(
			...
			'salign', '',
			'Flashvars','var1=<? echo $config_xml; ?>'
...
<noscript>
    ...
    <param name="Flashvars" value="var1=<? echo $config_xml; ?>" />
	<param name="movie" value="<? echo $template_dir; ?>swf/easyviewECCO.swf" /><param name="quality" value="high" /><param name="wmode" value="transparent" /><param name="bgcolor" value="#ffffff" />	<embed src="<? echo $template_dir; ?>swf/easyviewECCO.swf" quality="high" wmode="transparent" bgcolor="#ffffff" width="950" height="700" name="easyviewECCO" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" Flashvars="var1=<? echo $config_xml; ?>"/>
	</object>
</noscript>
            </div><!--
