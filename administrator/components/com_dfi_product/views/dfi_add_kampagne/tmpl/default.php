...
<form action="index.php?option=com_dfi_product&tmpl=component" method="post" name="adminForm" id="adminForm">
  ...
  <table>
    ...
    <tr>
      <td width="200" align="right" class="key"><label for="<? echo $this->prefix; ?>dfi_supplier_id"> <?php echo JText::_( strtoupper('Dfi_supplier_id') ); ?>: </label>
      </td>
	...
	<tr>
      ...
      <td><input class="text_area" type="text" name="<? echo $this->prefix; ?>hvidpris" id="<? echo $this->prefix; ?>hvidpris" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->hvidpris);?>" />&nbsp;<span id="s_hvidpris"></span>
      </td>
    </tr>

	<tr>
      <td width="100" align="right" class="key"><label for="<? echo $this->prefix; ?>rodpris"> <?php echo JText::_( 'Før/efter' ); ?>: </label>
      </td>
      <td><input class="text_area" type="text" name="<? echo $this->prefix; ?>rodpris" id="<? echo $this->prefix; ?>rodpris" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->rodpris);?>" />&nbsp;<span id="s_rodpris"></span>
      </td>
    </tr>
	
	<tr>
      <td width="100" align="right" class="key"><label for="<? echo $this->prefix; ?>nupris"> <?php echo JText::_( 'Nu pris' ); ?>: </label>
      </td>
      <td><input class="text_area" type="text" name="<? echo $this->prefix; ?>nupris" id="<? echo $this->prefix; ?>nupris" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->nupris);?>" />&nbsp;<span id="s_nuspris"></span>
      </td>
    </tr>
