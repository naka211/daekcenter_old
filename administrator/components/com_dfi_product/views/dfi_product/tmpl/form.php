...
<form action="index.php?option=com_dfi_product" method="post" name="adminForm" id="adminForm">
	...
	<table class="admintable">
		...
		<tr <?php if($this->check){ echo 'style="display: none;"'; }?>>
		...
		<tr <?php if($this->check){ echo 'style="display: none;"'; }?>>
			...
			<td><input class="text_area" type="text" name="<?php echo $this->prefix; ?>wee" id="<?php echo $this->prefix; ?>wee" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->wee);?>" />&nbsp;
			</td>
		</tr>
		...
		<tr <?php if($this->check){ echo 'style="display: none;"'; }?>> 
			...
			<td><input class="text_area" type="text" name="<?php echo $this->prefix; ?>hvidpris" id="<?php echo $this->prefix; ?>hvidpris" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->hvidpris);?>" />&nbsp; <span id="s_hvidpris"><?php if($this->v_hvidpris):?><?php echo $this->v_hvidpris .'%';?><?php endif;?></span>
			</td>
		</tr>
		
		<tr <?php if($this->check){ echo 'style="display: none;"'; }?>>
			<td width="100" align="right" class="key"><label for="<?php echo $this->prefix; ?>rodpris"> <?php echo JText::_( strtoupper('Rodpris') ); ?>: </label>
			</td>
			<td><input class="text_area" type="text" name="<?php echo $this->prefix; ?>rodpris" id="<?php echo $this->prefix; ?>rodpris" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->rodpris);?>" />&nbsp; <span id="s_rodpris"><?php if($this->v_rodpris):?><?php echo $this->v_rodpris .'%';?><?php endif;?></span>
			</td>
		</tr>

		<tr <?php if($this->check){ echo 'style="display: none;"'; }?>>
			<td width="100" align="right" class="key"><label for="<?php echo $this->prefix; ?>nupris"> <?php echo JText::_( strtoupper('Nupris') ); ?>: </label>
			</td>
			<td>
				<input class="text_area" type="text" name="<?php echo $this->prefix; ?>nupris" id="<?php echo $this->prefix; ?>nupris" size="10" maxlength="250" value="<?php echo ws_dot_to_comma($this->dfi_product->nupris);?>" />&nbsp; <span id="s_nuspris"><?php if($this->v_nuspris):?><?php echo $this->v_nuspris .'%';?><?php endif;?></span>
			</td>
		</tr>
        ...
        <?php if($this->check){?>
            <tr>
                <td width="100" align="right" class="key">&nbsp;
                  ...
                  <td>
            	  	<input type="submit" value="Save" name="Save" onclick="javascript: submitbutton('save')" />
