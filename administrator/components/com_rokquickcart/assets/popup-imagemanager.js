...
var ImageManager = {
	...
	onok: function()
	{
		...
		window.parent.$(this.editor).setProperty('value', url);
		if (typeof(window.parent.$(this.editor).onchange) == "function") {
			window.parent.$(this.editor).onchange();
		}
		return false;
	},
	...
	setFolder: function(folder)
	{
		...
		this.frame.location.href='index.php?option=com_rokquickcart&view=imagesList&tmpl=component&folder=' + folder;
	},
