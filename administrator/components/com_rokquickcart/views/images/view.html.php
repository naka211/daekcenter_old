 ...
 * @since 1.0
 */
class RokQuickCartViewImages extends JView
{
	function display($tpl = null)
	{
		...
		JHTML::_('script'    , 'popup-imagemanager.js', $append .'components/com_rokquickcart/assets/');
		JHTML::_('stylesheet', 'popup-imagemanager.css', $append .'components/com_rokquickcart/assets/');
