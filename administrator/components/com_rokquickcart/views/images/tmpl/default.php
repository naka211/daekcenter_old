...
var image_base_path = "images/rokquickcart";
</script>
<form action="index.php" id="imageForm" method="post" enctype="multipart/form-data">
	...
	<iframe id="imageframe" name="imageframe" src="index.php?option=com_rokquickcart&amp;view=imagesList&amp;tmpl=component&amp;folder=<?php echo $this->state->folder?>"></iframe>

	<fieldset>
		<table class="properties">
			<tr>
				<td><label for="f_url"><?php echo JText::_('Image URL') ?></label></td>
				<td><input type="text" id="f_url" value="" size="80" maxlength="255"/></td>
			</tr>
		</table>
	</fieldset>
...
<?php if ($canUpload) : ?>			
	<form action="<?php echo JURI::base(); ?>index.php?option=com_rokquickcart&amp;task=file.upload&amp;tmpl=component&amp;<?php echo $this->session->getName().'='.$this->session->getId(); ?>&amp;pop_up=1&amp;<?php echo JUtility::getToken();?>=1" id="uploadForm" method="post" enctype="multipart/form-data">
		<fieldset>
		...
		<input type="hidden" name="return-url" value="<?php echo base64_encode('index.php?option=com_rokquickcart&view=images&tmpl=component&e_name='.JRequest::getCmd('e_name')); ?>" />
</form>
<?php endif; ?>
