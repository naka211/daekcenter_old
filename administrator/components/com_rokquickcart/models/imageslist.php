 ...
 * @since 1.5
 */
class RokQuickCartModelImagesList extends JModel
{
	...
	function getList()
	{
		...
		if (strlen($current) > 0) {
			$basePath = COM_ROKQUICKCART_BASE.DS.$current;
		} else {
			$basePath = COM_ROKQUICKCART_BASE;
		}
		$mediaBase = str_replace(DS, '/', COM_ROKQUICKCART_BASE.'/');
