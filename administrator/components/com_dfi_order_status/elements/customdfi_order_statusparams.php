...
/**
 * @version $Id$
 * @package Dfi_order_status
 * @subpackage	Dfi_order_status
 * @copyright Copyright (C) 2009 Dfi_order_status. All rights reserved.
...
class JElementCustomDfi_order_statusParams extends JElement
{
	/**
	* Element name
	*
	...
	* @var		string
	*/
	var	$_name = 'CustomDfi_order_statusParams';
