...
/**
* Dfi_order_status Table class
*
* @package		Joomla
* @subpackage	Dfi_order_status
* @since 1.0
*/
class TableDfi_order_status extends JTable
{
	...
	function __construct(& $db) {
		parent::__construct('#__dfi_order_statuses', 'dfi_order_status_id', $db);
	}
	...
	*/
	...
	function check()
	{
		if (!$this->dfi_order_status_id)
		{
			// check insert
			//$query = 'SELECT a.dfi_order_status_id FROM #__dfi_order_statuses a' .
			//	' WHERE a.dfi_order_status_id = '.$this->dfi_order_status_id;
