...
/**
 * @version $Id$
 * @package Dfi_review_product
 * @subpackage	Dfi_review_product
 * @copyright Copyright (C) 2009 Dfi_review_product. All rights reserved.
...
class JElementCustomDfi_review_productParams extends JElement
{
	/**
	* Element name
	*
	...
	* @var		string
	*/
	var	$_name = 'CustomDfi_review_productParams';
