				...
				if (isset($item->linkparts['view']))
				{
					...
					if (isset($item->linkparts['layout'])) {
						...
						$layout = 'default';
                                        ...
                                        if($item->linkparts['option'] == 'com_myshop'){                                            
                                            $lpath = JPATH_ROOT.DS.'shop/components'.DS.$item->linkparts['option'].DS.'views'.DS.$item->linkparts['view'].DS.'tmpl'.DS.$layout.'.xml';
                                            $vpath = JPATH_ROOT.DS.'shop/components'.DS.$item->linkparts['option'].DS.'views'.DS.$item->linkparts['view'].DS.'metadata.xml';
                                        }else{
