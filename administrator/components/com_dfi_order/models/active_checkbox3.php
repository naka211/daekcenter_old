 ...
 * @since 1.5
 */
class Dfi_ordersModelActive_checkbox3 extends JModel
{
	/**
	 * Dfi_order ata array
	 *
	...
	function __construct()
	{
		...
		$this->_supplier_id		= $mainframe->getUserStateFromRequest( $option.'dfi_supplier_id',	'dfi_supplier_id',	0,				'int' );
        $this->_campaign_id		= $mainframe->getUserStateFromRequest( $option.'dfi_campaign_id',	'dfi_campaign_id',	0,				'int' );
    ...
    function getDfi_campaign_id()
	{
		return $this->_campaign_id;
	}
    
    function getCheck_ok(){
        $query = "SELECT * FROM #__dfi_kobreaks WHERE dfi_kobreak_id = ".$this->_checkbox_id;
        $this->_db->setQuery($query);
		$check_ok =  $this->_db->loadObjectList();
