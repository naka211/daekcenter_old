...
/**
 * @version $Id$
 * @package Dfi_campaign
 * @subpackage	Dfi_campaign
 * @copyright Copyright (C) 2009 Dfi_campaign. All rights reserved.
...
class JElementCustomDfi_campaignParams extends JElement
{
	/**
	* Element name
	*
	...
	* @var		string
	*/
	var	$_name = 'CustomDfi_campaignParams';
