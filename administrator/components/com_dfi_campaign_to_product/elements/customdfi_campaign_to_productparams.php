...
/**
 * @version $Id$
 * @package Dfi_campaign_to_product
 * @subpackage	Dfi_campaign_to_product
 * @copyright Copyright (C) 2009 Dfi_campaign_to_product. All rights reserved.
...
class JElementCustomDfi_campaign_to_productParams extends JElement
{
	/**
	* Element name
	*
	...
	* @var		string
	*/
	var	$_name = 'CustomDfi_campaign_to_productParams';
