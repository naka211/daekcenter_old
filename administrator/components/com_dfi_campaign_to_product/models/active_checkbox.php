<?php
/**
 * @version		$Id: active_checkbox.php 13431 2010-06-22 15:50:50 ngo.bieu@mwc.vn $
 * @package		Joomla
...
/**
 * Dfi_campaign_to_products Component Dfi_campaign_to_product Model
 *
 * @package		Joomla
 * @subpackage	Active_checkbox
 * @since 1.5
 */
class Dfi_campaign_to_productsModelActive_checkbox extends JModel
{
	/**
	 * Dfi_campaign_to_product ata array
	 *
	 * @var array
	 */
	var $_data = null;
	...
	/**
	 * Method to get dfi_campaign_to_products item data
	 *
	 * @access public
	 * @return array
	 */
	...
	/**
	 * Method to get the total number of dfi_campaign_to_product items
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object for the dfi_campaign_to_products
	 *
	 * @access public
	 * @return integer
	 */
	...
	function _buildQuery()
	{
		...
		$fkey = Dfi_campaign_to_product_active_checkboxHelper::checkbox_fkey();
		$ckey = Dfi_campaign_to_product_active_checkboxHelper::checkbox_key();
		$query = 'SELECT b.*,a.dfi_campaign_id,a.dfi_campaign_to_product_id'
				. ' FROM #__dfi_products b' // editable
				. ' LEFT JOIN #__dfi_campaign_to_products a ON a.'.$ckey.'=b.'.$ckey
