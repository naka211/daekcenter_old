...
/**
* Dfi_campaign_to_product Table class
*
* @package		Joomla
* @subpackage	Dfi_campaign_to_product
* @since 1.0
*/
class TableDfi_campaign_to_product extends JTable
{
	var $dfi_campaign_to_product_id;
	var $dfi_product_id;
	var $dfi_campaign_id;
	...
	function __construct(& $db) {
		parent::__construct('#__dfi_campaign_to_products', 'dfi_campaign_to_product_id', $db);
	}
	...
	*/
	...
	function check()
	{
		if (!$this->dfi_campaign_to_product_id)
		{
			// check insert
			//$query = 'SELECT a.dfi_campaign_to_product_id FROM #__dfi_campaign_to_products a' .
			//	' WHERE a.dfi_campaign_to_product_id = '.$this->dfi_campaign_to_product_id;
			//$this->_db->setQuery($query);
			//$xid = intval($this->_db->loadResult());
			//if ($xid)
			//{
			//	$this->dfi_campaign_to_product_id = $xid;
			//}
			//return !$xid;
		} else {
			// check update
	...
	/**
	 * Method to store the dfi_campaign_to_product
	 *
	 * @access	public
	 * @return	boolean	True on success
	 * @since	1.5
