<?php
/**
 * @version		$Id: dfi_campaign_to_product_active_checkbox.php 13431 2010-06-22 15:50:50 ngo.bieu@mwc.vn $
 * @package		Joomla
 ...
 */
class Dfi_campaign_to_product_active_checkboxHelper
{
	...
	{
		$key = 'dfi_campaign_product_id';
		$fkey = self::checkbox_fkey();
		$ckey = self::checkbox_key();

		$query = 'SELECT b.*,a.dfi_campaign_id,a.'.$key
		...
		global $mainframe;
		$option = 'com_dfi_campaign_to_product';
