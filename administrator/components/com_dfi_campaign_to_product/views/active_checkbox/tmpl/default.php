...
?>
<script language="javascript" src="<?php echo $this->lists['comdir']; ?>dfi_campaign_to_product.js"></script>
<form action="<?php echo $this->action; ?>" method="post" name="adminForm">
  ...
  <div id="editcell">
    <table class="adminlist">
      <thead>
        <tr>
		  ...
		  <th width="1%" nowrap="nowrap"> <?php echo JHTML::_('grid.sort',  'ID', 'a.dfi_campaign_product_id', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>
        </tr>
      </thead>
      <tfoot>
        <tr>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$ckey = Dfi_campaign_to_product_active_checkboxHelper::checkbox_key();
        ...
        <tr class="<?php echo $selected?"row3":"row$k"; ?>">
		  ...
		  <td><span class="editlinktip hasTip" title="<?php echo JText::_( strtoupper('Edit Dfi_campaign_to_product') );?>::<?php echo $this->escape($row->dfi_product_id); ?>"><a href="<?php echo $link; ?>">
            <?php
		  ...
		  <td>
            <?php
				echo $this->escape($row->dfi_campaign_id);
				?> </td>
			
          <td align="center"><?php echo $row->dfi_campaign_product_id; ?> 
		  <!--<input name="dfi_campaign_product_id_<?php echo $row->$ckey; ?>" type="hidden" value="<?php echo $row->dfi_campaign_product_id; ?>" />-->
		  </td>
        </tr>
        <?php
		$k = 1 - $k;
  ...
  <input type="hidden" name="option" value="com_dfi_campaign_to_product" />
