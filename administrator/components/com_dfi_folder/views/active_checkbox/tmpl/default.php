...
?>
<script language="javascript" src="<?php echo $this->lists['comdir']; ?>dfi_folder.js"></script>
<form action="<?php echo $this->action; ?>" method="post" name="adminForm">
  ...
  <div id="editcell">
    <table class="adminlist">
      <thead>
        <tr>
		  ...
		  <th class="title"> <?php echo JHTML::_('grid.sort',  JText::_( ('Product Name') ), 'd.product_name', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>
		  ...
		  <th class="title"> <?php echo JHTML::_('grid.sort',  JText::_( ('Shop') ), 'cc.company_name', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>

		  <th class="title"> <?php echo JHTML::_('grid.sort',  JText::_( ('Ordered') ), 'c.sent', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>
		  
		  <th class="title"> <?php echo JHTML::_('grid.sort',  JText::_( ('Købeark') ), 'ccc.name', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>
          
		  <th width="1%" nowrap="nowrap"> <?php echo JHTML::_('grid.sort',  'ID', 'a.dfi_order_product_folder_id', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>
        </tr>
      </thead>
      <tfoot>
        <tr>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
        ...
        <tr class="<?php echo $selected?"row3":"row$k"; ?>">
		  ...
		  <td>
            <?php
				echo JHTML::_('date',  $row->order_date, JText::_('%Y-%m-%d') );
				?> </td>
          ...
          <td align="center"><?php echo $row->dfi_order_product_folder_id; ?> 
		  <!--<input name="dfi_order_product_folder_id_<?php echo $row->$ckey; ?>" type="hidden" value="<?php echo $row->dfi_order_product_folder_id; ?>" />-->
		  </td>
        </tr>
        <?php
		$k = 1 - $k;
  ...
  <input type="hidden" name="option" value="com_dfi_folder" />
