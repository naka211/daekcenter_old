...
/**
 * @version $Id$
 * @package Dfi_supplier
 * @subpackage	Dfi_supplier
 * @copyright Copyright (C) 2009 Dfi_supplier. All rights reserved.
...
class JElementCustomDfi_supplierParams extends JElement
{
	/**
	* Element name
	*
	...
	* @var		string
	*/
	var	$_name = 'CustomDfi_supplierParams';
