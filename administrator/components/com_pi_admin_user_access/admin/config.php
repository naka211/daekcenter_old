...
<link href="components/com_pi_admin_user_access/css/pi_admin_user_access2.css" rel="stylesheet" type="text/css" />
...
<form name="adminForm" method="post" action="">
	...
	<div style="text-align: left;">	
		...
		<table class="adminlist">			
			...
			<tr>		
				<td>
					<?php echo _pi_ua_lang_statusmod.' ('._pi_ua_lang_frontend.')'; ?>
				</td>
				<td>
					<?php 					
					if($class_ua->module_frontend_installed){
						echo '<div style="color: #5F9E30;">'._pi_ua_lang_modinstalled_frontend.'</div>';		
					}else{
						echo '<div style="color: red;">'._pi_ua_lang_warning.' '._pi_ua_lang_modnotinstalled.'</div>';
					}
					if($class_ua->module_published_frontend){
						echo '<div style="color: #5F9E30;">'._pi_ua_lang_modpublished.'</div>';		
					}else{
						echo '<div style="color: red;">'._pi_ua_lang_modnotpublished.'</div>';
					}
					if(!$class_ua->module_frontend_show_title && $class_ua->module_frontend_installed){
						echo '<div style="color: #5F9E30;">'._pi_ua_lang_mod_not_show_title.'</div>';		
					}else{
						echo '<div style="color: red;">'._pi_ua_lang_mod_show_title.'</div>';
					}
					if($class_ua->module_frontend_show_on_all_pages){
						echo '<div style="color: #5F9E30;">'._pi_ua_lang_mod_show_on_all_pages.'</div>';		
					}else{
						echo '<div style="color: red;">'._pi_ua_lang_mod_not_show_on_all_pages.'</div>';
					}	
					?>
				</td>
			</tr>
			<?php
			if($class_ua->aua_version_type!='free'){				
			?>
			<tr>		
				<td>
					<?php 
					echo _pi_ua_lang_statusbot;					
					?>
				</td>
				<td>
					<?php 
			...
			<tr>		
				<td>
					<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_redirect_to_pi_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_redirect_to_pi; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_redirect_to_pi; ?></span></span>
				</td>
				<td>
					<input type="checkbox" name="redirect_to_pi" value="true" <?php if($class_ua->ua_config['redirect_to_pi']){echo 'checked="checked"';} ?> />
				</td>
			</tr>					
			<tr>
				<td colspan="2">
			...
			<tr>		
				<td width="300">
					<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_showjoomlagroup_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_showjoomlagroup; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_showjoomlagroup; ?></span></span>
				</td>
				<td>
			...
			<tr>		
				<td>
					<?php echo _pi_ua_lang_disableselectbox; ?>
				</td>
				<td>
					<input type="checkbox" name="disable_joomla_group_selectbox" value="true" <?php if($class_ua->ua_config['disable_joomla_group_selectbox']){echo 'checked="checked"';} ?> />
				</td>
			</tr>
			<tr>		
				<td>
				...
				<td>
					<?php
					if($class_ua->aua_version_type=='free'){						
						echo '<span style="color: red;">'._pi_ua_lang_not_in_free_version2.'</span> ';
						echo '<br />';
					}
					?>
			...
			<tr>		
				<td>
					<span class="editlinktip" onmouseover="return overlib('<?php echo _pi_ua_lang_activatepipage_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_activatepipage; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_activatepipage; ?></span>					
				</td>
				<td>
			...
			<tr>		
				<td>
					<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_inherit_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_inherit; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_inherit; ?></span></span>					
				</td>
				<td>
			...
			<tr>		
				<td width="300">
					<span class="editlinktip" onmouseover="return overlib('<?php echo _pi_ua_lang_activatepiitemtypes_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_activatepiitemtypes; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_activatepiitemtypes; ?></span>
				</td>
				<td>
			...
			<tr>		
				<td>
					<span class="editlinktip" onmouseover="return overlib('<?php echo _pi_ua_lang_activateitems_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_activateitems; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_activateitems; ?></span>
				</td>
				<td>
			...
			<tr>		
				<td width="300">
					<span class="editlinktip" onmouseover="return overlib('<?php echo _pi_ua_lang_activatesections_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_activatesections; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_activatesections; ?></span>
				</td>
				<td>
			...
			<tr>		
				<td width="300">
					<span class="editlinktip" onmouseover="return overlib('<?php echo _pi_ua_lang_activatecategories_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_activatecategories; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_activatecategories; ?></span>
				</td>
				<td>
			...
			<tr>		
				<td>
					<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_notifyaddress_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_notifyaddress; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_notifyaddress; ?></span></span>					
				</td>
				<td>
			...
			<tr>		
				<td width="300">
					<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_use_componentaccess_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_use_componentaccess; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_use_componentaccess; ?></span></span>
				</td>
				<td>
			...
			<tr>		
				<td colspan="2">
					<table class="adminlist">
						<tr>
							<td>
								<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_useinpiuseraccess_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_useinpiuseraccess; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_useinpiuseraccess; ?></span></span>
							</td>							
							<td>
								<?php echo _pi_ua_lang_componentname; ?>
							</td>
							<td>								
								<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_alias_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_alias; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_alias; ?></span></span>
							</td>
							<td>
						...
						<?php
							...
							$class_ua->db->setQuery("SELECT * FROM #__components"  );							
							//$class_ua->db->setQuery("SELECT name, option FROM #__components"  ); why this does not work, I do not know
							$rows = $class_ua->db-> loadObjectList();	
							$components_db = array();						
							...
							foreach($rows as $row){	
								...
								if($row->name=='Categories' || $row->name=='Manage Categories'){
									//if(defined('_JEXEC')){
										//joomla 1.5.x	
										//$option = 'com_categories&section=com_content';	
									//}else{
										//joomla 1.0.x
			...
			<tr>
				...
				<td>
					<?php echo _pi_ua_lang_adminlink; ?> = 
					<?php echo stripslashes(_pi_ua_lang_adminlink_tip); ?>
				</td>
			</tr>			
			</table>
			</div>
			...
			<tr>		
				<td>
					<span class="editlinktip"><span onmouseover="return overlib('<?php echo _pi_ua_lang_use_toolbar_tip; ?>', CAPTION, '<?php echo _pi_ua_lang_use_toolbar; ?>', BELOW, RIGHT, WIDTH, 400);" onmouseout="return nd();" ><?php echo _pi_ua_lang_use_toolbar; ?></span></span>
				</td>
				<td>
			...
			<tr>		
				...
				<td>
					...
					<textarea name="example" class="extra_button_field" style="height: 130px;" cols="80" /><li><a href="javascript: var winl = (screen.width - 900) / 2;
