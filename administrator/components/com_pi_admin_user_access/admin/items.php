...
<table class="adminlist">
	...
	<?php
		...
		foreach($items as $item){						
			...
			/*
			if($class_ua->ua_config['display_itemtype_in_list'] && $class_ua->pi_installed){
				$item_type = '';
				if(!$item->itemtype){
					$item_type = $class_ua->translate_item_type('text');
				}else{
					$item_type = $class_ua->translate_item_type($item->itemtype);
				}
				echo ' ('.$item_type.')';
			}
			*/
