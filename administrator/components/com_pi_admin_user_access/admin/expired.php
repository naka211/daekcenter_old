...
//footer
echo '<div class="smallgrey" id="ua_footer"><a href="http://www.pages-and-items.com/admin-user-access" target="_blank">Admin-User-Access</a> &copy; version 1.2.8 commercial license</div>';
