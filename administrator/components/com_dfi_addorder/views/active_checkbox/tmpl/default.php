...
<form action="<?php echo $this->action; ?>" method="post" name="adminForm">
  <table>
    <tr>
        <td align="left" width="100%">
            ...
            <button onclick="document.getElementById('task').value='active_checkbox';this.form.submit();"><?php echo JText::_('Save'); ?></button>
  ...
  <div id="editcell">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
        ...
        <tr class="<?php echo $selected?"row3":"row$k"; ?>">
		  ...
		  <td>
            <input name="quantity[]" type="text" value="<?php echo $this->escape($row->quantity); ?>" />
  ...
  <input type="hidden" name="option" value="com_dfi_addorder" />
