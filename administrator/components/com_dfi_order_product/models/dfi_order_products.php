<?php
/**
 * @version		$Id: dfi_order_products.php 29593 2010-01-04 14:16:21 ngo.bieu@mwc.vn $
 * @package		Joomla
 ...
 * @since 1.5
 */
class Dfi_order_productsModelDfi_order_products extends JModel
{
	/**
	 * Category ata array
	 *
	...
	function _buildContentWhere()
	{
		...
		if ($search) {
			$_where[] = 'LOWER(a.dfi_order_id) LIKE '.$db->Quote( '%'.$db->getEscaped( $search, true ).'%', false );
