...
/**
 * @version $Id$
 * @package Dfi_order_product
 * @subpackage	Dfi_order_product
 * @copyright Copyright (C) 2009 Dfi_order_product. All rights reserved.
...
class JElementCustomDfi_order_productParams extends JElement
{
	/**
	* Element name
	*
	...
	* @var		string
	*/
	var	$_name = 'CustomDfi_order_productParams';
